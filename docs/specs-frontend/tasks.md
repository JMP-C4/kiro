...
- [x] 1.1 Inicializar proyecto con Vite + React + TypeScript
...
- [x] 1.2 Implementar cliente HTTP con interceptores JWT
...
- [x] 1.3 Implementar AuthContext y hook useAuth
...
- [x] 1.4 Implementar pantalla de Login
...
- [x] 1.5 Implementar ProtectedRoute y Router principal
...
- [x] 2.1 Implementar layout principal con navegación
...
- [x] 2.2 Implementar API y hook de Productos
...
- [x] 2.3 Implementar página de Productos — Listado
...
- [x] 2.4 Implementar búsqueda y filtro por categoría
